...
class GoodsChannelGroup(BaseModel):
    ...
    商品频道组
    """
    name = models.CharField(max_length=20, verbose_name='频道组名称')
...
class GoodsChannel(BaseModel):
    ...
    商品频道
    """
    group = models.ForeignKey(GoodsChannelGroup, verbose_name='频道组名称')
...
class Brand(BaseModel):
    ...
    first_letter = models.CharField(max_length=1, verbose_name='商品首页字母')
...
class SPU(BaseModel):
    ...
    desc_detail = models.TextField(default='', verbose_name='评价详情')
    desc_pack = models.TextField(default='', verbose_name='包装信息')
    desc_service = models.TextField(default='', verbose_name='售后信息')
